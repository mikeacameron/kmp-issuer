...
import (
	...
	"github.com/mikeacameron/kmp-issuer/internal/version"

	kmpissuerv1alpha1 "github.com/mikeacameron/kmp-issuer/api/v1alpha1"
...
func init() {
	...
	utilruntime.Must(kmpissuerv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.Issuer{
		HealthCheckerBuilder:     signer.KMPHealthCheckerFromIssuerAndSecretData,
		SignerBuilder:            signer.KMPSignerFromIssuerAndSecretData,
