...
// KMPClusterIssuer is the Schema for the kmpclusterissuers API.
...
func (vi *KMPClusterIssuer) GetConditions() []metav1.Condition {
...
func (vi *KMPClusterIssuer) GetIssuerTypeIdentifier() string {
	return "kmpclusterissuers.kmp.cert-manager.io"
}

// issuer-lib requires that we implement the Issuer interface
// so that it can interact with our Issuer resource.
var _ v1alpha1.Issuer = &KMPClusterIssuer{}
