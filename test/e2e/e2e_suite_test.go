...
var (
	...
	projectImage = "ghcr.io/mikeacameron/kmp-issuer:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting kmp-issuer integration test suite\n")
...
var _ = AfterSuite(func() {
	// Tear down Prometheus and CertManager after the suite if not skipped and if they were not already installed
